      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 355">
        ...
        <g id="train">
          ...
          <g id="car-layers">
            ...
            <g id="Text">
              <text transform="translate(377.037 230.025)" class="st8 st10" font-size="18" style="cursor: pointer;" @click="router.push('/')">
                主页
              </text>
              <text transform="translate(649.5 213.994)" class="st8 st10" font-size="24.025">
                404 页面找不到啦!
              </text>
            </g>
            <g id="ladders">
